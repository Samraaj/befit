...
// import { sendWelcomeTexts } from 'lib/TextingService';
	...
	return (
		<div>
			...
			<div className="flex h-screen justify-center ">
				<div className="flex flex-col items-center gap-5 bg-black px-10 pt-[5%] text-center text-white xs:w-[90%] sm:w-[640px]">
					...
					<PhoneInput
						...
						inputClass="rounded-lg bg-white py-2 px-6 focus:outline-none text-black"
